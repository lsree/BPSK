...
class BPSK_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._bb_gain_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.soapy_hackrf_source_0.set_bandwidth(0, 2.5)
        self.soapy_hackrf_source_0.set_frequency(0, freq)
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', rx_gain)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_win, 1, 3, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        # Connections
        ##################################################
        self.connect((self.soapy_hackrf_source_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.soapy_hackrf_source_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.soapy_hackrf_source_0, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', self.rx_gain)
