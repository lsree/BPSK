...
class usrp_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 1, 0, 2, "burst")
        ...
        self.epy_block_0 = epy_block_0.blk(threshold_db=-65, alpha=0.0141041, burst_tag_name="burst")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/rf/Documents/BPSK/usrp_rx_raw.iq', True, 0, 0)
