...
class BPSK_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_filter_taps = rrc_filter_taps = firdes.root_raised_cosine(1, samp_rate,samp_rate/sps, 0.5, ((sps)*nfilts))
        self.raw_iq_delay = raw_iq_delay = 200
        self.hdr_format = hdr_format = digital.header_format_default('1010101000111001',3, 1)
        ...
        self._raw_iq_delay_range = qtgui.Range(0, 200, 1, 200, 200)
        self._raw_iq_delay_win = qtgui.RangeWidget(self._raw_iq_delay_range, self.set_raw_iq_delay, "raw_iq_delay", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._raw_iq_delay_win)
        ...
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_ccc(1, rrc_filter_taps)
        ...
        self.digital_crc_append_0 = digital.crc_append(8, 0xB7, 0xFFFFFFFF, 0xFFFFFFFF, True, True, False, 0)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rf/Documents/BPSK/tx_sim.iq', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, raw_iq_delay)
        ...
        self.connect((self.blocks_repeat_0, 0), (self.qtgui_const_sink_x_0_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_filter_taps(firdes.root_raised_cosine(1, self.samp_rate, self.samp_rate/self.sps, 0.5, ((self.sps)*self.nfilts)))
    ...
    def set_rrc_filter_taps(self, rrc_filter_taps):
        ...
        self.interp_fir_filter_xxx_0_0.set_taps(self.rrc_filter_taps)

    def get_raw_iq_delay(self):
        return self.raw_iq_delay

    def set_raw_iq_delay(self, raw_iq_delay):
        self.raw_iq_delay = raw_iq_delay
        self.blocks_delay_0.set_dly(int(self.raw_iq_delay))
